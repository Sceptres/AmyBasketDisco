...
OBJDIR = obj
BINDIR = src
INCDIR = # Include dir that contains glfw3, glad, GLM, and TinyObjLoader header files
LIBDIR = # Lib dir that contains glfw3, glad, GLM, and TinyObjLoader library files

# Files and executables
TARGET = $(BINDIR)/AmyBucketDisco
